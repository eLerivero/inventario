                                ...
                                <div>
                                    ...
                                    <h3>
                                        ...
                                        $con_productos = array_filter($categorias, function($cat) {
                                            // Usar isset() para verificar si existe la clave
                                ...
                                <div>
                                    ...
                                    <h3>
                                        ...
                                        $activas = array_filter($categorias, function($cat) {
                                            // Si no existe 'activo', asumimos que está activa
                            ...
                            <table class="table table-striped table-hover" id="tablaCategorias">
                                ...
                                <tbody>
                                    <?php foreach ($categorias as $index => $categoria): 
                                        // Usar valores por defecto para campos que puedan faltar
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if (empty($descripcion)) {
                                                    ...
                                                    // Mostrar solo los primeros 80 caracteres con tooltip
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#tablaCategorias').DataTable({
        ...
        columnDefs: [
            ...
            { searchable: false, targets: [0, 3, 4, 5, 6] } // Deshabilitar búsqueda en algunas columnas
        ],
