...
class VentaController
{
        ...
        public function obtener($id)
    {
        try {
            ...
            if ($venta) {
                ...
                // Usar el método que obtiene TODOS los pagos, sin filtrar por "completado" (no existe ese estado en pagos_venta)
                ...
                // Calcular total pagado DESDE pagos_venta
                $totalPagadoUSD = 0;
                $totalPagadoBS = 0;
                $metodosUtilizados = [];
                ...
                // ... (resto del código para formatear detalles)
                foreach ($venta['detalles'] as &$detalle) {
                    // ... (código de formateo existente)
                }
    ...
    public function crear($data)
    {
        ...
        try {
            ...
            $ventaData = [
                ...
                'tipo_pago_id' => $data['pagos'][0]['tipo_pago_id'], // Guardamos el primer método como principal
                'subtotal' => $total_usd,
                'total' => $total_usd,
            ...
            foreach ($data['pagos'] as $pago) {
                ...
                if (!$this->pagoVenta->crear($pagoData)) {
            ...
            $resumenPagos = $this->pagoVenta->obtenerResumenPorVenta($venta_id);

            return [
                "success" => true,
                "message" => "Venta creada exitosamente con " . count($data['pagos']) . " método(s) de pago",
                "venta_id" => $venta_id,
    ...
    public function obtenerVentasPorMes()
    {
        try {
            ...
            error_log("Error en obtenerVentasPorMes: " . $e->getMessage());
            return [
                "success" => false,
    ...
    public function obtenerProductosConInfoCompleta()
    {
        try {
            ...
            error_log("Error en obtenerProductosConInfoCompleta: " . $e->getMessage());
            return [
                "success" => false,
    ...
    public function obtenerTotalVentasCompletadasBs()
    {
        try {
            ...
            error_log("Error en obtenerTotalVentasCompletadasBs: " . $e->getMessage());
            return [
                "success" => false,
    ...
    public function obtenerVentasActivasHoy()
    {
        try {
            ...
            error_log("Error en obtenerVentasActivasHoy: " . $e->getMessage());
            return [
                "success" => false,
    ...
    public function obtenerResumenHoy()
    {
        try {
            ...
            error_log("Error en obtenerResumenHoy: " . $e->getMessage());
            return [
                "success" => false,
    ...
    public function obtenerTotalPreciosFijosHoy()
    {
        try {
            ...
            error_log("Error en obtenerTotalPreciosFijosHoy: " . $e->getMessage());
            return [
                'success' => false,
    ...
    public function hayVentasActivas()
    {
        try {
            ...
            error_log("Error en hayVentasActivas: " . $e->getMessage());
            return [
                "success" => false,
    ...
    public function obtenerVentasCerradas($limit = 100)
    {
        try {
            ...
            error_log("Error en obtenerVentasCerradas: " . $e->getMessage());
            return [
                "success" => false,
